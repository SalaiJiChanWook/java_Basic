...
public class LogginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Loggin Your Account");
        ...
        logginBtn.setBackground(new java.awt.Color(204, 204, 204));
        logginBtn.setFont(new java.awt.Font("Yu Gothic UI Light", 1, 18)); // NOI18N
        logginBtn.setText("Loggin");
        logginBtn.setAutoscrolls(true);
        ...
        CancleBtn.setBackground(new java.awt.Color(204, 204, 204));
        CancleBtn.setFont(new java.awt.Font("Yu Gothic UI Light", 1, 18)); // NOI18N
        ...
        ExitBtn.setFont(new java.awt.Font("Yu Gothic UI Light", 1, 18)); // NOI18N
    ...
    private void logginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logginBtnActionPerformed
        if(txtUsername.getText().equals("Admin") && txtPasswords.getText().equals("admin123"))
        {
        ...
        {
            JOptionPane.showMessageDialog(null, "Username or passwords is wrong!");
        }
    ...
    private void ExitBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExitBtnActionPerformed
        JOptionPane.showMessageDialog(null, "GoodBye..kid");
        dispose();
